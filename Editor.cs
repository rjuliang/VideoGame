...
namespace FNAClassCode
{
    ...
    //1. Add the name of the object to the enum ObjectType. Make sure you add it BEFORE NumOfObjects.
    //2. Create the object in addButton_Click. Look for the huge comments showing you where to do that.
    ...
    public partial class Editor : Form
    {
        ...
        enum ObjectType
        {
            ...
            Enemy, PowerUp, IslamicEnemy, EnemyFifthLevel, IslamicEnemyFifthLevel, NumOfObjects,
        };
